...
import promovare_2020_1 from '../assets/events/promovare_2020_1.png';
import promovare_2020_2 from '../assets/events/promovare_2020_2.png';
import promovare_2020_3 from '../assets/events/promovare_2020_3.png';
import targ_stiinta_1 from '../assets/events/targul_stiinta_2019_1.png';
import targ_stiinta_2019_2 from '../assets/events/targul_stiinta_2019_2.png';
import targ_stiinta_2019_3 from '../assets/events/targul_stiinta_2019_3.png';
import anton from '../assets/events/promovare_anton_pann.png';
import energetic from '../assets/events/promovare_energetic.png';
import energetic_1 from '../assets/events/promovare_energetic_1.png';
import energetic_2 from '../assets/events/promovare_energetic_2.png';
import lahovari from '../assets/events/promovare_lahovari.png';
import lahovari_1 from '../assets/events/promovare_lahovari_1.png';
import lahovari_2 from '../assets/events/promovare_lahovari_2.png';
import lahovari_3 from '../assets/events/promovare_lahovari_3.png';
import fundraising from '../assets/events/eveniment_fundraising.png';
import fundraising_1 from '../assets/events/eveniment_fundraising_1.png';
import saptamana from '../assets/events/eveniment_saptamana.png';
import saptamana_1 from '../assets/events/saptamana_1.png';
import simpozion1 from '../assets/events/simpozion.png';
import simpozion_1 from '../assets/events/simpozion_1.png';
import simpozion_2 from '../assets/events/simpozion_2.png';
import cerc from '../assets/events/cerc.png';
import cerc_1 from '../assets/events/cerc_1.png';
import cerc_2 from '../assets/events/cerc_2.png';
import cerc2 from '../assets/events/cerc2.png';
import cerc2_1 from '../assets/events/cerc2_1.png';
import cerc2_2 from '../assets/events/cerc2_2.png';
import cerc2_3 from '../assets/events/cerc2_3.png';
import bursa from '../assets/events/bursa.png';
import bursa_1 from '../assets/events/bursa_1.png';
import bursa_2 from '../assets/events/bursa_2.png';
import bursa_3 from '../assets/events/bursa_3.png';
import workshop_2019 from '../assets/events/workshop_2019.png';
import workshop_2019_1 from '../assets/events/workshop_2019_1..png';
import workshop_2019_2 from '../assets/events/workshop_2019_1.png';
import nr10 from '../assets/events/nr10.png';
import nr10_1 from '../assets/events/nr10_1.png';
import nr10_2 from '../assets/events/nr10_2.png';
import nr10_3 from '../assets/events/nr10_3.png';
import simpozion2 from '../assets/events/simpozion2.png';
import simpozion2_1 from '../assets/events/simpozion2_1.png';
import simpozion2_2 from '../assets/events/simpozion2_2.png';
import simpozion2_3 from '../assets/events/simpozion2_3.png';
import codekids from '../assets/events/codekids2.jpg';
import codekids_1 from '../assets/events/codekids2_1.jpg';
import codekids_2 from '../assets/events/codekids2_2.jpg';
import zen from '../assets/events/zen.png';
import zen_1 from '../assets/events/zen_1.jpg';
import zen_2 from '../assets/events/zen_2.jpg';
import nr10cover from '../assets/events/nr10.1.png';
import nr101 from '../assets/events/nr10.3.png';
import nr102 from '../assets/events/nr10.4.png';
import nr103 from '../assets/events/nr10.5.png';
import nr104 from '../assets/events/nr10.6.png';
import nr105 from '../assets/events/nr10.7.png';
import nr106 from '../assets/events/nr10.8.png';
import energeticcover from '../assets/events/energeticcover.jpg';
import energetic1 from '../assets/events/energetic1.jpg';
import energetic2 from '../assets/events/energetic2.jpg';
import energetic3 from '../assets/events/energetic3.png';
import energetic4 from '../assets/events/energetic4.png';
import energetic5 from '../assets/events/energetic5.png';
import scoalanr10cover from '../assets/events/nr1021.jpg';
import nr1022 from '../assets/events/nr1022.jpg';
import nr1023 from '../assets/events/nr1023.jpg';
import nr1024 from '../assets/events/nr1024.jpg';
import nr1025 from '../assets/events/nr1026.jpg';
import nr2cover from '../assets/events/nr2cover.jpg';
import nr21 from '../assets/events/nr21.jpg';
import nr22 from '../assets/events/nr22.jpg';
import nr23 from '../assets/events/nr23.jpg';
import nr9cover from '../assets/events/nr9cover.png';
import nr91 from '../assets/events/nr91.png';
import nr92 from '../assets/events/nr92.png';
import nr93 from '../assets/events/nr93.png';
import pcover from '../assets/events/pcover.png';
...
import CNALcover from '../assets/events/CNALcover.png';
import CNAL1 from '../assets/events/CNAL1.png';
...
export const events = [
  {
    ...
    description:
      'Ieri am sărbătorit în avans Halloween-ul printr-un team building. Am fost împreună membri ai echipei și voluntari, ne-am jucat, am povestit, am pictat asa-ziși dovleci (grapefruit). A fost fumos, am interacționat unii cu alții și iam reușit să ne cunoaștem mai bine. 
      Happy Hallowen!,
    date: '28 Oct 2022',
    date_en: '28 Oct 2022',
...

{
  title_en: ' The BroBotSTEAM summer ',
    ...
    description:
    "Școala de vară BroBotSTEAM este în plină desfășurare la Colegiul Național "Alexandru Lahovari".
    Mulțumim Curierul De Vâlcea pentru că alegeți să prezentați activitatea tinerilor implicați în proiecte comunitare și rezultatele acestora!
    Împreună aducem viitorul mai aproape!
    http://www.curierul.ro/scoala-de-vara-brobotsteam-la.../" ,
    date: '19 July 2022',
...

  {
    ...
    description:
      'Activitățile din cadrul proiectului nostru susținut de Fundaţia Comunitară Vȃlcea au continuat astăzi cu un atelier de proiectare 3D la care au participat elevi din clasa a VII-a de la Școala Gimnazială "Anton Pann"din Râmnicu Vâlcea. Laura, Andi și Vlăduț le-au vorbit colegilor mai mici și despre competiția First Tech Challenge, despre tema acestu sezon competițional și despre activitatea echipei noastre. Mulțumim conducerii școlii și doamnei profesor Manuela Ivancu pentru sprijinul acordat în organizarea activității!',
    images: [nr9cover, nr91, nr92, nr93],
    //image to show in events page
    cover: nr9cover,
    location: 'Eveniment online',
    location_en: 'Online event',
...

  {
    ...
    description:
      'Proiectul nostru merge mai departe. Săptămâna aceasta, marți 09.03.2021, ne-am aflat online alături de colegi de-ai noștri din clasa a VII-a de la Școala Gimnazială "I. Gh. Duca" din Râmnicu Vâlcea. Sperăm ca prezentarea noastră să le fi trezit interesul pentru  ceea ce înseamnă educație STEM și proiectare 3D. Laura și Andi au fost din nou în prim plan. Mulțumim domnului profesor Ovidiu Ristea și conducerii Școlii Gimnaziale "I. Gh. Duca" pentru sprijin!',
    images: [scoalanr10cover, nr21, nr22, nr23],
    //image to show in events page
    cover: nr2cover,
    location: 'Eveniment online',
    location_en: 'Online event',
...

  {
    ...
    description:
      'Maratonul prezentărilor și atelierelor de proiectare 3D a continuat astazi, la început de primăvară, cu o nouă întâlnire cu elevi ai clasei a 7-a a Școlii Gimnaziale Nr. 10 din Râmnicu Vâlcea. De această dată Răzvan, Vlăduț, Ștefania și Laura le-au vorbit despre educație STEM, despre concursul de robotică BRD FIRST Tech Challenge Romania, despre echipa noastră și despre ceea ce înseamnă acest sezon competițional atipic (ce se desfășoară remote). Le mulțumim pentru interesul manifestat, pentru întrebările adresate!',
    images: [scoalanr10cover, nr1022, nr1023, nr1024, nr1025],
    //image to show in events page
...

  {
    ...
    description:
      'Astăzi ne-am întâlnit în mediul online cu elevi ai clasei a VII-a de la Școala Gimnazială Nr. 10 din Râmnicu Vâlcea. Andi și Laura le-au captat atenția cu prezentarea proiectării și printării 3D și apoi cu atelierul de proiectare 3D folosind Onshape. Am fost încântați de interesul manifestat de colegii noșstri mai mici. Mulțumim pentru sprijin conducerii Școlii Gimnaziale Nr. 10 și doamnei profesor Aurelia Tertereanu!',
    images: [nr101, nr10cover, nr102, nr103, nr104, nr105, nr106],
    //image to show in events page
    cover: nr10cover,
    location: 'Eveniment online',
    location_en: 'Online event',
...

  {
    ...
    description:
      'Astăzi, am avut bucuria de a fi gazdele întâlnirii online din cadrul simpozionului interjudețean “TIC în învățământul preuniversitar” – secțiunea destinată elevilor. Au fost dezbateri interesante pe temele propuse anul acesta: E-learnig sau modelul tradițional de învățare? și Educația STEM în contextual pandemiei actuale. Elevii participanți la simpozion au prezentat lucrări care au impresionat prin coerența ideilor expuse, prin modul ăn care au fost argumentate aceste idei si opiniile personale. Alături de noi au fost și profesorii participanți la secțiunea destinată profesorilor, alumnii Lahovari/BroBots (studenți). Le mulțumim mult pentru prezența alături de noi doamnei inspector școlar pentru informatică Doina Merlan, doamnei diectoor Issabella Ştefania Cataragă care este și co-mentor al echipei noastre alături de doamna profesor Simona Ianc) și domnului director adjunct Tudosoiu Daniel! Mulțumim tuturor profesorilor catedrei de informatică alături de care am reușit să organizăm acest eveniment. Mulțumim Andrei-Cosmin Toma pentru că ai fost din nou alături de noi! ',
    images: [simpozion2, simpozion2_1, simpozion2_2, simpozion2_3],
    //image to show in events page
    cover: simpozion2,
    location: 'Eveniment online',
    location_en: 'Online event',
...

  {
    ...
    description:
      'Astăzi am participat în calitate de invitați la  CODE Kids FEST 2020 – Târgul Județean de Știință și Tehnologie pentru copii. Am făcut o scurtă prezentare a proiectului nostru din sezonul SKYSTONE și am urmărit cu mare interes prezentările elevilor de la cluburiile înscrise în concurs. Ca și anul trecut am fost impresionați de ceea ce au realizat colegii noștri mai mici. Ne bucurăm că și anul acesta locul I a revenit clubului Wizards Code Club - Pietrari.  Îî felicităm și le dorim mult succes în continuare!',
...

  {
    ...
    description:
      'Final de eveniment THE ZEN OF PROGRAMMING AND ROBOTICS. Astăzi echipa noastră a fost protagonista unui webinar în care am vorbit despre educația STEM, robotică, concursul BRD FIRST Tech Challenge Romania, pasiuni, provocările situației actuale. Colegii noștri mai mici din clasele a 9-a, a 7-a și a 6-a au fost interresați de prezentarea noastră și ne-au adresat multe întrebări. Mulțumim alumnilor Andrei Constantin și Valeriu Stroe care s-au aflat alături de noi! \nEvenimentul este finanțat cu ajutorul inițiativei Meet and Code susținută la nivel european de compania de software SAP. În România, inițiativa este coordonată de #AsociațiaTechsoup și susține evenimente de tehnologie și programare desfășurate în timpul Europe Code Week. ',
...

  {
    ...
    description:
      'O primă întâlnire a avut loc la Colegiul Energetic din Râmnicu Vâlcea. Le-am vorbit colegilor noștri despre educaţia STEM, le-am prezentat proiectul asociaţiei Naţie prin educaţie, formatul competiției First Tech Challenge și ce înseamnă să faci parte dintr-o echipă de robotică. La întâlnire au participat: Andrei Dobrete – team – leader – ul echipei (asamblare & programare), Gabriel Fota – asamblare & programare, Valeriu Stroe – proiectare, Grigorie Smarandache – proiectare & asamblare şi Darius Alexandru-Muşat - asamblare. Am făcut şi o demonstraţie cu robotul construit de noi. Prezentarea noastră a fost primită cu interes şi sperăm ca o echipă din acest colegiu să ni se alăture în competiţie în sezonul următor.',
    images: [energetic, energetic_1, energetic_2],
    //image to show in events page
    cover: energetic,
...

  {
    ...
    description:
      'Pe 15 decembrie 2019 s-a desfăşurat Simpozionul interjudeţean „TIC în învăţământul preuniversitar” organizat de Colegiul Naţional „Alexandru Lahovari”. Am participat la secţiunea dedicată elevilor a simpozionului. Am vorbit despre educaţia STEM şi despre proiectul BRD FIRST Tech Challenge Romania. Am făcut şi o demonstraţie cu robotul cu care participăm anul acesta în competţie. Laura Simion (membră a echipei din acest sezon) ne-a vorbit despre proiectele STEM în care a fost implicată până în acest moment, Andrei Constantin şi Valeriu Stroe au prezentat lucrări în cadrul simpozionului iar Andrei Mihai (student - membru al echipei în sezonul trecut) ne-a prezentat lucrarea cu care a câştigat menţiune la faza naţională o olimpiadei de istorie şi societate în dimensiune virtuală (proiectul îmbină istoria şi informatica). Ne-au impresionat lucrările prezentate de colegii noştri, lucrări ce s-au încadrat în cele două teme propuse: securitate cibernetică şi educaţie STEM (lucrarea colegului din clasa a XI-a de la Colegiul Naţional de Informatică "Matei Basarab" (Adrian-Ilie), roboţelul colegelor din clasa a VI-a (Ana și Erika) cu care au participat la concursul nextlab.tech şi celelalte lucrări). Echipa noastră a primit Premiul I la secţiunea educaţie STEM pentru prezentarea făcută. La aceeaşi secţiune Laura Simion a obţinut Premiul I la clasa a IX-a, Andrei Constantin Premiul I la clasa a XII-a iar Valeriu Stroe Premiul II la clasa a XII-a. ',
    images: [simpozion1, simpozion_1, simpozion_2],
    //image to show in events page
    cover: simpozion1,
...

  {
    ...
    description:
      'În săptămâna 25-29 noiembrie s-a desfășurat în școala noastră acțiunea intitulată “Săptămâna fructelor și legumelor donate”, acțiune care face parte din calendarul activităților SNAC (stratega națională de acțiune comunitară). Membrii echipei de robotică BroBots alături de mentorul lor (care este și coordonator SNAC în școala noastră) au fost inițiatorii activității și alături de alți elevi ai școlii au donat fructe și legume care au ajuns la familii nevoiașe din cadrul parohiei “Biserica Parohială Pogorârea Sfântului Duh, Sfântul Antim, Sfântul Stelian” din Râmnicu Vâlcea. Întotdeauna ne alăturam unor astfel de acțiuni de caritate și o facem cu mare drag.',
    images: [saptamana, saptamana_1],
    //image to show in events page
    cover: saptamana,
    location: 'Colegiul Național "Alexandru Lahovari", Râmnicu Vâlcea',
    location_en: '"Alexandru Lahovari" National College, Ramnicu Valcea',
...

  {
    ...
    description:
      'George Hulubă, Andrei Dobrete, Grigorie Smarandache şi Darius Alexandru-Muşat au participat astăzi la atelierul Fundraising - tips and tools (atelier despre strângere de fonduri) organizat de Fundaţia Comunitară Vȃlcea unde au aflat lucruri interesante despre resurse, instrumente și mecanisme de fundraising, care pot ajuta organizațiile mari si mici să se dezvolte. Invitaţia a venit din partea doamnei Gabriela Solomon (absolventă a Colegiului “Alexandru Lahovari”) unul dintre membrii fondatori ai Fundaţiei Comunitare Vâlcea. Atelierul a făcut parte din seria de intâlniri Sharing The Good Work inițiate de platforma Galantom.ro la care s-a alăturat Asociația Techsoup și Asociația pentru Relații Comunitare. Aceste ateliere sunt dedicate ONG-urilor și grupurilor de inițiativă și încurajează schimbul de experiență în domeniul fundraising-ului și fundraising-ului online în special. A fost o experienţă interesantă. \nAu învăţat despre: \n1. START Fundraising - de ce e important să ții cont când începi o campanie de fundaising ca să te asiguri că tot ceea ce faci îți va aduce fonduri și în anii următori, nu doar acum? De unde începi? Pe cine implici? Cum îi convingi pe donatori să ți se alăture? \n2. Programul TechSoup pentru organizații nonprofit - beneficii și resurse de invațare, Google AdGrants din Programul Google for Nonprofits și Airbnb Social Impact Experiences. \n3. Peer to peer fundraising - cum poți să îți transformi fanii în fundraiseri, cu exemple și studii de caz din campaniile desfășurate prin platforma Galantom.ro. \nInformaţiile acumulate în urma participării lor la acest atelier ne vor ajuta în organizarea activitţii de foundraising în cadrul echipei cu atât mai mult cu cât echipa BroBots de anul acesta este una complet nouă (foştii membrii ai echipei sunt acum studenţi) şi nu există experienţă anterioară.',
    images: [fundraising, fundraising_1],
    //image to show in events page
    cover: fundraising,
...

  {
    ...
    description:
      'Astăzi am onorat invitaţia de a participa, în calitate de invitaţi speciali, la cea de a treia ediţie a Târgului de Ştiinţă – ediția Tech ce a avut loc la Biblioteca Judeţeană „Antim Ivireanul” Vâlcea.Târgul de Știință este un eveniment tematic organizat în cadrul proiectului “CODE Kids – copiii fac coding în bibliotecile publice”, proiect implementat de Fundația Progress în parteneriat cu Biblioteca Judeţeană „Antim Ivireanul” Vâlcea și alte 7 biblioteci publice din județul Vâlcea. Copiii nu învață doar programare ci își dezvoltă competențe digitale, de robotică și STEM în cadrul cluburilor CODE Kids. Am avut un stand de prezentare a echipei în cadrul târgului. Echipa a fost reprezentată de Andrei Constantin (12A), Andrei Dobrete (10B), Gabriel Fota (12A), Eduard Enache (12A), Valeriu Stroe (12A), George Hulubă (8B), Grigorie Smarandache (11A), Darius Alexandru-Muşat (11A). Alături de noi, tot în calitate de invitaţi speciali, s-au aflat şi membrii echipei Bionic Royals (RO 142) de la Colegiul Naţional “Mircea cel Bătrân”.Am urmărit cu interes prezentarea proiectelor realizate de copiii din cluburile CODE kids care funcţionează la bibliotecile publice din judeţul Vâlcea. Am fost impresionaţi de proiectele prezentate de cei mici. Am remarcat echipa clubului CODE Kids din Pietrari care a şi câştigat competiţia. Începând din acest sezon Laura Simion (clasa a IX-a) membră a acestui club face parte din echipa noastră.Noi le-am prezentat copiilor din cluburile CODE kids dar şi vizitatorilor târgului proiectul organizaţiei “Naţie prin Educaţie”, concursul “First Tech Challenge”, ce implică participarea în acest concurs, tema de anul acesta a concursului şi robotul la care am început să lucrăm. Membrii cluburilor prezente dar şi vizitatorii târgului (elevi din clasele I-VIII) au fost foarte încântaţi şi au ascultat cu atenţie explicaţiile noastre. Le-am oferit stickere şi insigne cu sigla echipei dar şi ocazia de a testa manevrarea robotului nostru. Standul nostru a fost un punct de atracţie în cadrul târgului. Pentru noi, a fost o bucurie să vedem încântarea de pe feţelor copiilor, să putem răspunde curiozităţilor lor, să îi ajutăm în manevrarea robotului. Sperăm ca peste câţiva ani să ne urmeze în cadrul competiţiei.La eveniment au fost prezente şi televiziunile locale care au luat înterviuri şi au realizat reportaje.',
    images: [
      targ_stiinta_2019_3,
      targ_stiinta_1,
      targ_stiinta_2019_2,
...

  {
    ...
    description:
      'Echipa BroBots a sprijinit iniţiativa fostului elev al colegiului nostru, Alexandru Hogea (în prezent research engineer la Universitatea Politehnica Bucureşti, Facultatea de Automatică şi Calculatoare”) şi mentorului echipei noastre, prof. Simona Ianc, care au organizat împreună cu Asociaţia "Alexandru Lahovari" şi în colaborare cu Biblioteca Judeţeană "Antim Ivireanul" în zilele de 10 – 13 octombrie 2019 un workshop de 4 zile dedicat tinerilor care vor să înveţe cum să realizeze o aplicaţie web de la zero, trecând prin toţi paşii. Worskhop-ul a fost structurat pe 4 capitole principale, care reprezintă şi etapele de realizare a unei platforme: arhitectura, design şi frontend, date, backend. Fiecare capitol a avut dedicată câte o zi, împarţită în două secţiuni, parte teoretică şi parte practică. Platforma web realizată în urma workshop-ului este platformă în stilul "Pinterest" sau "Tumblr", unde oamenii pot să posteze lucruri şi să îşi facă un profil. Evenimentul a câștigat o finanțare prin inițiativa Meet and Code susținută la nivel european de compania de software SAP. În România, inițiativa este coordonată de #AsociațiaTechsoup și susține evenimente de tehnologie și programare desfășurate în timpul Europe Code Week. Membrii echipei, împreună cu cei doi mentori, au participat activ la organizarea evenimentului (realizarea afişului, a diplomelor de participare, …) la care au participat şi în calitate de cursanţi. Workshop-ul s-a bucurat de un real interes din partea elevilor participanţi urmând să fie organizate alte asemenea evenimente şi la începutul anului următor. \nÎn ultima zi a workshop-ului câţiva dintre membrii echipei noastre, le-au vorbit participanţilor despre proiectul asociaţiei “Naţie prin educaţie”, despre concursul “First Tech Challenge”, le-au prezentat tema de anul acesta şi le-au propus colegilor din alte şcoli să ni se alăture în următorul sezon. ',
    images: [workshop_2019, workshop_2019_1, workshop_2019_2],
    //image to show in events page
    cover: workshop_2019,
    location: 'Biblioteca Județeană "Antim Ivireanu", Ramnicu Valcea',
    location_en: 'County Library "Antim Ivireanu"',
...

  {
    ...
    description:
      'Astăzi, 12 aprilie 2019, Colegiul Naţional "Alexandru Lahovari" a fost gazda cercului pedagogic al profesorilor de informatică din judeţul Vâlcea. Echipa de robotică a colegiului - BroBots a fost invitată să facă o prezentare in cadrul cercului. Le-am vorbit invitaţilor despre educaţia STEM, despre proiectul asociaţie “Naţie prin Educaţie”, le-am prezentat proiectul First Tech Challenge, traseul nostru în competiţia de anul acesta şi le-am povestit despre ce a însemnat pentru fiecare dintre noi această experienţă. Profesorii prezenţi la cercul pedagogic ne-au adresat multe întrebări ce au vizat modalitatea de înscriere în proiect, construcţia robotului, modul în care am reuşit să obţinem sponsorizări care să acopere cheltuielile pe care le implică participarea la acest concurs (procurarea de noi piese pentru construcţia robotului, deplasarea şi cazarea la competiţiile demonstrative, regionale şi naţionale, …). Am făcut şi o demonstraţie cu robotul Hector cu care am participat la etapa naţională a concursului “First Tech Challenge”. Colegul nostru Andrei Mihai a prezentat aplicaţia BroBotsApp realizată de el (realitate augmentată). Prezentarea noastră s-a bucurat de un real succes, am fost felicitaţi de către profesorii participanţi şi de către doamna inspector pentru parcursul nostru foarte bun în primul an de participare în concurs, pentru Premiul II – Think Award obţinut la regionalele de la Timişoara. Ne-am bucurat că am putut impărtăşi tuturor profesorilor de informatică din judeţ experienţa noastră din acest prim sezon competiţional.  ',
    images: [cerc, cerc_1, cerc_2],
    //image to show in events page
    cover: cerc,
    location: 'Colegiul Național "Alexandru Lahovari", Râmnicu Vâlcea',
...

  {
    ...
    description:
      'Astăzi am participat la evenimentul organizat de Inspectoratul Şcolar al Judeţului Vâlcea la Liceul Tehnologic Forestier: “Bursa ofertelor şcolare – învăţământ liceal 2019”. Alături de câţiva profesori şi elevi ai colegiului nostru am promovat imaginea liceului nostru, le-am vorbit elevilor de clasa a VIII-a participanţi la târg despre proiectul în care suntem implicaţi, despre competiţia “First Tech Challenge” şi am făcut scurte demonstraţii cu robotul. Ne-am reîntâlnit şi cu prietenii noştri din echipa Bionic Royals a Colegiului Naţional “Mircea cel Bătrân” care la fel ca noi participau la promovarea imaginii şcolii lor. No iam fost reprezentaţi la eveniment de Andrei Toma (marketing şi comunicare), Silviu Preoteasa (asamblare) şi de către mentorul nostru Simona Ianc. Sperăm că am convins cât mai mulţi elevi de clasa a VIII-a să opteze pentru profilul matematică-informatică (sau orice alt profil) de la Colegiul Naţional “Alexandru Lahovari”. ',
    images: [bursa, bursa_1, bursa_2, bursa_3],
    //image to show in events page
    cover: bursa,
