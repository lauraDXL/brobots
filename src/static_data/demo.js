...
export const events = [
  {
    ...
    description_en:
      'On February 15, 2020, we participated in the last demo before the regional competition in Timisoara. The event was organized by the TITANS team (“Gheorghe Lazăr” National College, Bucharest) at the Politehnica University of Bucharest. It was an expected reunion with members of the FIRST community. We spent many pleasant moments with the other teams participating in the competition and we collaborated very well with the teams we were in alliances with during the six qualifying matches played.',
    description:
...

  {
    ...
    description_en:
      'On January 24, 2020, on the day of the Little Union, we were present in Sibiu, at "Sala Transilvania" at a demo organized by the Gear Maniacs team. The second demo of this competitive season gave us reasons to become even more confident in our strengths. There was a clear evolution compared to the first demo both in terms of the operation of the robot but also in terms of how our drivers managed on the field. It was a very nice atmosphere. We spent many pleasant moments with the other teams participating in the competition. I collaborated very well with the teams I was in alliances with during the five qualifying matches played.',
    description:
...

  {
    ...
    description_en:
      'In the weekend of December 14-15, 2019, we participated in the first demo of this season, a demo organized by our friends from the Bionic Royals team - RO042 (“Mircea cel Bătrân” National College, Râmnicu Vâlcea). It was an interesting experience considering that our team is a completely new one and it was our first contact with what the "First Tech Challenge" competition means. We entered the atmosphere of the FTC competition, we went through the technical inspection of the robot, we saw how the matches take place, how the game strategies are established in a few words, we made new friends. We tested the robot\'s behavior on the playing field in competition conditions, we tested the skill of the drivers, we saw the pros and cons of the team.',
    description:
...

  {
    ...
    description_en:
      'On the weekend of November 24-25, 2018, we participated in the first demo organized by our friends from the Bionic Royals team - RO042. It was an interesting experience. We entered the atmosphere of the FTC competition, we saw how the matches unfold, we made new friends. We have shown that new teams can do very well (in a short time, without initial knowledge but with a lot of work and imagination).',
    description:
